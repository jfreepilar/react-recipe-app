    ...
    return (
      <>
        <div className='flex mr-16 mb-6 h-72
                        ...
                        max-md:h-[500px]'>
        {/* <div className={styles1.quoteMainContainer}> */}

            <img src='src/assets/savory-spoon.png' className='h-56 w-96 mt-[-22px] ml-14
                                                              max-xl:h-50 max-xl:w-44' alt="Savory Spoon Logo"/>
